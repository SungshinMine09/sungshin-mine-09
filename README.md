...
>🛠️개발기간 : 
><br>2023.3.15 ~ 2023.4.18 (프로젝트 계획, 데이터베이스 설계, 플로우차트 및 와이어프레임 설계)
...
## 💜팀원 소개
- <b>👑배기연</b>(정보시스템공학과) - 플로우차트 / <b>상품소개, 새소식, 채팅</b> 기능 구현 / QA
- <b>탁유제</b>(컴퓨터공학과) - 플로우차트 / <b>DB 생성, 공동구매방 생성, 입금폼 전과정(제작, 계좌 노출, 제출, 통계)</b> 구현 / 최종발표
- <b>권형미</b>(컴퓨터공학과) - 플로우차트 / <b>마이페이지, 알림페이지</b> 기능 구현 / QA
- <b>손승현</b>(융합보안공학과) - 와이어프레임 / <b>기본 라우팅, 이메일 인증, 회원가입, 로그인+로그아웃, 아이디 찾기+비밀번호 재설정, 아이디/비밀번호 변경</b> 기능 구현 / 배포
- <b>김다현</b>(통계학과) - 와이어프레임 / <b>홈 화면, 전체 공구방, 수요조사 통계, 공동구매방 삭제</b> 기능 구현 / QA

⚡프로젝트 계획, 데이터베이스 설계 : ***모든 팀원 참여***
...
### 공동구매방
- 홈화면, 공동구매방 생성 및 삭제, 상품 상세 정보 조회, 모든 공동구매 조회(=전체 공구방), <br>수요조사 단계 상품 조회, 마감임박 단계 상품 조회, 수요조사 참여(only 참여자), 수요조사 통계(only 주최자), <br>새소식 생성(only 주최자), 새소식 확인, 채팅방 생성, 채팅 메세지 조회 및 전송 
### 입금폼
- 입금폼 양식 생성(only 주최자), 입금폼 작성(only 참여자), 입금계좌 확인, 입금폼 전체결과 조회(only 주최자)

<p align="center">
  <h4>📷그림 한 장으로 기능 파악하기 👇🏻</h4>

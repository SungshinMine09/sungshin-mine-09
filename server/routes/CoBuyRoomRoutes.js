...
router.get("/:id/chatting/:login_id", verifyAuthController.checkAuth, verifyAuthController.checkChatRoomByUserID, ChatController.chatRoom, ChatController.indexView);

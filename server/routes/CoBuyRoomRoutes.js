...
router.get(
  ...
  CoBuyRoomDetailController.index,
  CoBuyRoomDetailController.indexView
); // 공구방 상세페이지
router.get(
  "/:id/suyoStat",
  verifyAuthController.checkAuth,
...
router.get(
  "/createNewPost",
  verifyAuthController.checkAuth,
  CoBuyRoomController.createNewPost
);
router.get(
  "/createCoBuyRoom",
  verifyAuthController.checkAuth,
  CoBuyRoomController.createCoBuyRoomPage
);
router.post(
  "/createCoBuyRoom",
...
router.get(
  ...
  CoBuyRoomDetailController.index,
  CoBuyRoomDetailController.indexView
); // 상의후 다현님 코드와 합치거나 할 것
router.get("/:id/chatting", CoBuyRoomDetailController.chatting);

router.get(
  "/:id/updateCurrentDemand",
  CoBuyRoomDetailController.updateCurrentDemand,
  CoBuyRoomDetailController.redirectView
);
router.get("/:id/deleteCoBuyRoom", CoBuyRoomDetailController.deleteCoBuyRoom);

router.get(
  "/:id/CoBuyForm/fillDepositForm",
  CoBuyRoomDetailController.fillDepositForm
);
router.get(
  "/:id/CoBuyForm/submitDepositForm",
  CoBuyRoomDetailController.submitDepositForm
);
...
router.get(
  "/:id/newpost",
  verifyAuthController.checkAuth,
  NewpostController.index,
  NewpostController.indexView
);
...
router.get(
  ...
  CreatePostController.indexView
);
router.post(
  "/:id/createPost/create",
  CreatePostController.createPost,
  CreatePostController.redirectView
);
